            ...
            {vitamins.map((vitamin, index) => (
              <motion.div
                ...
                className={`flex items-center mb-12 ${
                  vitamin.side === 'left' ? 'justify-end md:pr-8' : 'justify-start md:pl-8'
                }`}
              ...
              >
                <div className={`w-full md:w-5/12 ${vitamin.side === 'left' ? 'text-right' : 'text-left'}`}>
                  <div className={`p-6 rounded-2xl shadow-lg bg-white transform transition-transform hover:scale-105 ${
                    vitamin.side === 'left' ? 'mr-4' : 'ml-4'
                  }`}>
